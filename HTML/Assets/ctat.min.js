...
b,c){b.getSelection().includes("done")&&"ButtonPressed"===b.getAction()&&a.setDoneStepFailed(!0);c?(a.setResult(CTATExampleTracerLink.BUGGY_ACTION),a.setTraceOutcome(CTATExampleTracerLink.BUGGY_ACTION)):(a.setResult(CTATExampleTracerLink.NO_MODEL),a.setTraceOutcome(CTATExampleTracerLink.NO_MODEL));c=q.getAllNextSteps();a.setTracerInfo(c,"next_steps");a=b.getSelection();v.all++;v[a]?v[a]++:v[a]=1}function a(a,b,c,d){var e=c.hints.map(function(a){return a.msg}),f=c.rules,g=c.skills,h=c.sai,n=a.getStudentSAI();
c=c.customFields;var l=c.step_id?c.step_id:""+h.selection+(h.selection&&h.action?" ":"")+h.action+"",e=CTATGlobals.languageManager.interpolateStrings(e,new CTATVariableTable,n);p("debug","ruleTracer.handleHintResult,\n\ttutorSAI = "+JSON.stringify(h)+"\n\tassociated rules = "+f+"\n\tassociated skills = "+g+"\n\tstep ID = "+l+"\n\tcustom fields = "+JSON.stringify(c)+"\n\thints (interpolated) = "+JSON.stringify(e));a.setTutorSAI(new CTATSAI(h.selection,h.action,h.input));a.setResult(CTATExampleTracerLink.HINT_ACTION);
a.setTraceOutcome(e.length?CTATExampleTracerLink.HINT_ACTION:CTATExampleTracerLink.NO_MODEL);a.setReportableHints(e);a.setActor(CTATMsgType.DEFAULT_STUDENT_ACTOR);a.setStepID(l);a.setAssociatedSkills(g);a.setAssociatedRules(f);a.setCustomFields(c);v={all:0};b(d)}function d(a){n&&n.enqueueToolActionToStudent(a.selection,a.action,a.input,"tutor-performed")}function h(a){return{selection:a.getSelection()||"",action:a.getAction()||"",input:a.getInput()||""}}function l(){var a=q.getProblemAttribute("auto_hint"),
b=q.getProblemAttribute("auto_hint_threshold");if("all"===a?v.all>=b:"selection"===a&&Object.keys(v).some(function(a){return"all"!==a&&v[a]>=b}))p("debug","at consecutive error threshold, sending hint request..."),CTATCommShell.commShell.processComponentAction(new CTATSAI("hint","ButtonPressed","hint request"))}var n=g,p=CTATNoolsTracerLogger.log,q=null,u=null,v={all:0},y=this;this.getEngine=function(){return q};this.initEngine=function(a,c,e){switch(b){case "nools":q=new CTATNoolsTracer(p,d,n)}var g=
function(a,b){console.log("CTATRuleTracer.doneInit");f(q.getSkills());c(a,b)};q&&q.init(a,g,e)};this.getModelInitialized=function(){return q&&q.getInitialized()};this.getProblemStateStatus=function(){return n.getOutputStatus()};this.setListener=function(a,b){q.setListener(a,b)};this.evaluate=function(a,b){a.setTutorType("rule");var c=h(a.getStudentSAI());a=e.bind(y,a,b);c=q.evaluate.bind(q,c,a,"tutored_action");return q.getIAmPregenerating()?(q.setDonePregenCallback(c),!1):c()};this.doHint=function(b,
c,d){b.setTutorType("rule");b.setTransactionID(c);return q.evaluate(h(b.getStudentSAI()),a.bind(this,b,d),"hint")};this.handleUntutoredAction=function(a,b){p("debug","ruleTracer.handleUntutoredAction()",JSON.stringify(a),b);q.evaluate({selection:a.selection[0],action:a.action[0],input:a.input[0]},null,"untutored_action")};this.checkOutOfOrder=function(a,b){q.getProblemAttribute("hint_out_of_order")?(a=h(a.getStudentSAI()),a=!q.getTutorSAIs()[a.selection]):a=!1;b(a)};this.setDefaultBuggyMsg=function(a){a&&
"string"===typeof a&&(u=a)};this.getDefaultBuggyMsg=function(){return u};this.reset=function(a){q.reset(a)}};var CTATHintPolicyEnum=function(){};Object.defineProperty(CTATHintPolicyEnum,"HINTS_UNBIASED",{enumerable:!0,configurable:!1,writable:!1,value:"Always Follow Best Path"});Object.defineProperty(CTATHintPolicyEnum,"HINTS_BIASED_BY_CURRENT_SELECTION_ONLY",{enumerable:!0,configurable:!1,writable:!1,value:"Bias Hints by Current Selection Only"});Object.defineProperty(CTATHintPolicyEnum,"HINTS_BIASED_BY_PRIOR_ERROR_ONLY",{enumerable:!0,configurable:!1,writable:!1,value:"Bias Hints by Prior Error Only"});
